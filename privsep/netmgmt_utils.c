    ...
    )
{
    ...
    static const NetmgmtCli cli_commands[] = {
        ...
        { "add-additional-gw",            ncm_link_add_additional_gw },
        { "add-rule",                     ncm_link_add_routing_policy_rules },
        { "remove-rule",                  ncm_link_remove_routing_policy_rules },
        ...
        { "set-ipv6mtu",                  ncm_link_set_network_ipv6_mtu },
        ...
        { "set-ipv4proxyarp",             ncm_link_set_network_section_bool },
        { "set-ipv6proxyndp",             ncm_link_set_network_section_bool },
        { "set-conf-without-carrier",     ncm_link_set_network_section_bool },
        ...
        { "add-dhcpv4-server",            ncm_link_add_dhcpv4_server },
        { "remove-dhcpv4-server",         ncm_link_remove_dhcpv4_server },
        { "add-ipv6ra",                   ncm_link_add_ipv6_router_advertisement },
        { "remove-ipv6ra",                ncm_link_remove_ipv6_router_advertisement },
        ...
        { "create-vlan",                  ncm_create_vlan },
        { "create-bridge",                ncm_create_bridge },
        { "create-bond",                  ncm_create_bond },
        { "create-vxlan",                 ncm_create_vxlan },
        { "create-macvlan",               ncm_create_macvlan },
        { "create-macvtap",               ncm_create_macvlan },
        { "create-ipvlan",                ncm_create_ipvlan },
        { "create-ipvtap",                ncm_create_ipvlan },
        { "create-vrf",                   ncm_create_vrf },
        { "create-veth",                  ncm_create_veth },
        { "create-ipip",                  ncm_create_tunnel },
        { "create-sit",                   ncm_create_tunnel },
        { "create-gre",                   ncm_create_tunnel },
        { "create-vti",                   ncm_create_tunnel },
        { "create-wg",                    ncm_create_wireguard_tunnel },
        { "remove-netdev",                ncm_remove_netdev },
        { "reload",                       ncm_network_reload },
        { "reconfigure",                  ncm_link_reconfigure },
        { "set-proxy",                    ncm_configure_proxy },
        { "add-nft-table",                ncm_nft_add_tables },
        { "delete-nft-table",             ncm_nft_delete_table },
        { "add-nft-chain",                ncm_nft_add_chain },
        { "delete-nft-chain",             ncm_nft_delete_chain },
        { "add-nft-rule",                 ncm_nft_add_rule_port },
        { "delete-nft-rule",              ncm_nft_delete_rule },
        { "nft-run",                      ncm_nft_run_command },
        {}
    };
