...
#define ERROR_PMD_GPMGMT_CANNT_LOAD_JSON        (ERROR_PMD_GP_BASE + 4)
#define ERROR_PMD_GPMGMT_JSON_PARSE_ERROR       (ERROR_PMD_GP_BASE + 5)
#define ERROR_PMD_GPMGMT_JSON_UNKNOWN_KEY       (ERROR_PMD_GP_BASE + 6)
#define ERROR_PMD_GPMGMT_JSON_UNKNOWN_VALUE     (ERROR_PMD_GP_BASE + 7)
#define ERROR_PMD_GPMGMT_JSON_UNKNOWN_TIME_FMT  (ERROR_PMD_GP_BASE + 8)
#define ERROR_PMD_GPMGMT_UNKNOWN_POLICY         (ERROR_PMD_GP_BASE + 9)
#define ERROR_PMD_GPMGMT_SIGNAL_ERROR           (ERROR_PMD_GP_BASE + 10)
